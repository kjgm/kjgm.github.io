---
title: "STreeD: Separable Trees with Dynamic programming"
collection: software
category: software
permalink: /software/2023_odt_streed
excerpt: 'STreeD is a DP framework that can optimize trees for a variety of objectives and constraints.'
date: 2023-12-31
...
See the [examples](https://github.com/AlgTUDelft/pystreed/tree/main/examples) folder for a number of example usages.
...
See [examples/accuracy_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/accuracy_example.py) for an example.
...
See [examples/cost_sensitive_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/cost_sensitive_example.py) for an example.
...
See [examples/instance_cost_sensitive_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/instance_cost_sensitive_example.py) for an example.
...
See [examples/group_fair_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/group_fair_example.py) for an example.
...
See [examples/prescriptive_policy_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/prescriptive_policy_example.py) for an example.
...
See [examples/regression_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/regression_example.py) for an example.
...
See [examples/piecewise_linear_regression_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/piecewise_linear_regression_example.py) for an example.
...
See [examples/survival_analysis_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/survival_analysis_example.py) for an example.
...
See [examples/binarize_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/binarize_example.py) for an example.

## Overfitting and tuning

To prevent overfitting the size of the tree can be tuned. This can be done in the standard way using `scikit-learn` methods, see [examples/gridsearch_example.py](https://github.com/AlgTUDelft/pystreed/tree/main/examples/gridsearch_example.py). 
